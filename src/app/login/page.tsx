  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        ...
        <h2 className="mt-6 text-center text-4xl font-bold bg-gradient-to-r from-green-800 to-emerald-800 bg-clip-text text-transparent">
          Selamat Datang
        </h2>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        <div className="bg-white/80 backdrop-blur-sm py-8 px-4 shadow-2xl sm:rounded-2xl sm:px-10 border border-white/20 transition-all duration-300 hover:shadow-xl">
          ...
          <div className="mt-6 text-center">
            <p className="text-xs text-gray-500">
              © 2024 Sistem Prediksi Masa Tanam • Desa Pisangsambo
            </p>
          </div>
        </div>
      </div>
